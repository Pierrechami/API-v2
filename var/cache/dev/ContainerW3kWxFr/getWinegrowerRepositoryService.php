 ...
 */
class getWinegrowerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WinegrowerRepository' shared autowired service.
     *
     * @return \App\Repository\WinegrowerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WinegrowerRepository.php';

        return $container->privates['App\\Repository\\WinegrowerRepository'] = new \App\Repository\WinegrowerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
